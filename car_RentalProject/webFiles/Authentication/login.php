...
<div class="redirect"><a href="./signup.php">Create Account</a></div>
<?php
...
while($row=mysqli_fetch_assoc($searchResult)){
  ...
  $_SESSION["companyName"]=null;
   header("location:../index.php?email=".$_SESSION["email"].'&& username='.$_SESSION["username"]);
}
}
else{
  echo'<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Oops seems like no such data  exist. Please Create your Account</strong>
