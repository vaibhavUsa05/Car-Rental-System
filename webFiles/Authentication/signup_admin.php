...
<h3 class="heading">SIGNUP AS ADMIN</h3>
...
<div class="redirect"><a href="./admin.php">Already have an Account?</a></div>
<?php
...
$sql="INSERT INTO `admin`(`EMAIL`, `PASSWORD`, `Company_Name`) VALUES ('$email','$password','$company_name')";
...
if($res){
  ...
  <strong>This perhaps happend because the credentials you entered already exist</strong>
  ...
  echo'<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Oops seems like there has some error occured. Try Again !!</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
